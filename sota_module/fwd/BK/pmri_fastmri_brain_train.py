...
ROOT_PATH = '/opt/project1/fastmri_brain_multicoil_train/'

DATASHEET = pandas.read_csv(os.path.join(ROOT_PATH, 'fastmri_brain_multicoil_train.csv'))
...
for idx_ in range(4469):
    load_real_dataset_handle(
        idx_,
        acceleration_rate=1,
        is_return_y_smps_hat=False
    )
